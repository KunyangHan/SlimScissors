...
class SegmentationNetwork(nn.Module):
    ...
    def forward(self, input):
        ...
        coarse_outs[0] = torch.sigmoid(self.upsample(coarse_outs[0]))
        coarse_outs[1] = torch.sigmoid(self.upsample(coarse_outs[1]))
        coarse_outs[2] = torch.sigmoid(self.upsample(coarse_outs[2]))
        coarse_outs[3] = torch.sigmoid(self.upsample(coarse_outs[3]))
